...
@property (strong, nonatomic) UIColor *backgroundColor UI_APPEARANCE_SELECTOR;      // default is VSDK_WHITE_COLOR
@property (strong, nonatomic) UIColor *foregroundColor UI_APPEARANCE_SELECTOR;      // default is VSDK_BLACK_COLOR
...
+ (void)setForegroundColor:(UIColor*)color;                         // default is VSDK_BLACK_COLOR, only used for SVProgressHUDStyleCustom
+ (void)setBackgroundColor:(UIColor*)color;                         // default is VSDK_WHITE_COLOR, only used for SVProgressHUDStyleCustom
