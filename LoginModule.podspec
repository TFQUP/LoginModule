...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/TFQUP/LoginModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TFQUP' => '8791703+tfqup@user.noreply.gitee.com' }
  s.source           = { :git => 'https://github.com/TFQUP/LoginModule.git', :tag => s.version.to_s }
